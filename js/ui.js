...
import { state, esc } from './state.js?v=202609042200';
import { resizeWhiteboardIfVisible } from './whiteboard.js?v=202609042200';
...
export function go(page) {
  ...
  if (el) {
    ...
    import("./tasks.js?v=202609042200").then(m => m.capBoardColumnHeights()).catch(() => {});
    ...
    if (page === "reference") import("./reference.js?v=202609042200").then(m => m.showWorldMap());
  }
