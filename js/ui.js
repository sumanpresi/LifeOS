...
import { state, esc } from './state.js?v=202609262330';
import { resizeWhiteboardIfVisible } from './whiteboard.js?v=202609262330';
...
export function go(page) {
  ...
  if (el) {
    ...
    import("./tasks.js?v=202609262330").then(m => m.capBoardColumnHeights()).catch(() => {});
    ...
    if (page === "reference") import("./reference.js?v=202609262330").then(m => m.showWorldMap());
  }
