...
Object.assign(window,
  ...
  { addTask: tasks.addTask, toggleTask: tasks.toggleTask, editTask: tasks.editTask, delTask: tasks.delTask,
    ...
    restoreArchivedTask: tasks.restoreArchivedTask, deleteArchivedTaskPermanently: tasks.deleteArchivedTaskPermanently,
    setArchivedSort: tasks.setArchivedSort },
  ...
  { addNgdr: gsi.addNgdr, editProjectTask: gsi.editProjectTask, setTaskStatus: gsi.setTaskStatus, delProjectTask: gsi.delProjectTask,
    ...
    archiveCompletedTasks: gsi.archiveCompletedTasks, toggleGsiLinkEdit: gsi.toggleGsiLinkEdit,
