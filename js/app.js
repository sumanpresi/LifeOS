...
Object.assign(window,
  ...
  { addTask: tasks.addTask, toggleTask: tasks.toggleTask, editTask: tasks.editTask, delTask: tasks.delTask,
    ...
    setTaskView: tasks.setTaskView, calendarPrevMonth: tasks.calendarPrevMonth, calendarNextMonth: tasks.calendarNextMonth, calendarGoToday: tasks.calendarGoToday, toggleCalendarDay: tasks.toggleCalendarDay,
