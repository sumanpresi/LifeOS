...
import { setRenderer } from './state.js?v=202609262357';
import * as ui from './ui.js?v=202609262357';
import * as tasks from './tasks.js?v=202609262357';
import * as goals from './goals.js?v=202609262357';
import * as habits from './habits.js?v=202609262357';
import * as widgets from './widgets.js?v=202609262357';
import * as sections from './sections.js?v=202609262357';
import * as gsi from './gsi.js?v=202609262357';
import * as personal from './personal.js?v=202609262357';
import * as share from './share.js?v=202609262357';
import * as theme from './theme.js?v=202609262357';
import { initCursorGlow } from './cursor-glow.js?v=202609262357';
import { releaseDragGhost } from './drag-cleanup.js?v=202609262357';
import * as composer from './composer.js?v=202609262357';
import { initDropToAttach, handleIncomingShare } from './attach.js?v=202609262357';
import * as finance from './finance.js?v=202609262357';
import * as health from './health.js?v=202609262357';
import * as medStats from './med-stats.js?v=202609262357';
import * as eisenhower from './eisenhower.js?v=202609262357';
import * as healthPulse from './health-pulse.js?v=202609262357';
import * as travel from './travel.js?v=202609262357';
import * as reference from './reference.js?v=202609262357';
import * as notebook from './notebook.js?v=202609262357';
import * as trash from './trash.js?v=202609262357';
import * as backup from './backup.js?v=202609262357';
import * as entertainment from './entertainment.js?v=202609262357';
import * as taskModal from './task-modal.js?v=202609262357';
import { decorateLinkRows } from './link-preview.js?v=202609262357';
import { flushLocalSave } from './state.js?v=202609262357';
import * as healthCheck from './health-check.js?v=202609262357';
import * as dateShortcuts from './date-shortcuts.js?v=202609262357';
import * as expandView from './expand-view.js?v=202609262357';
import * as mapCoords from './map-click-coords.js?v=202609262357';
import * as calScribble from './calendar-scribble.js?v=202609262357';
import * as whiteboard from './whiteboard.js?v=202609262357';
import * as search from './search.js?v=202609262357';
import * as cloud from './supabase.js?v=202609262357';
import { applyNavOrder, initNavSorting } from './nav-order.js?v=202609262357';
import * as gcal from './google-calendar.js?v=202609262357';
import { initCommunicationBridge } from './communication-bridge.js?v=202609262357';
import { initNgdrTrackerBridge } from './ngdr-tracker-bridge.js?v=202609262357';
...
try {
  ...
  if (/[?&]debug=shake\b/.test(location.search)) {
    import("./shake-probe.js?v=202609262357")
