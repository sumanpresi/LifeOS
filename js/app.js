...
import { setRenderer } from './state.js?v=202609262300';
import * as ui from './ui.js?v=202609262300';
import * as tasks from './tasks.js?v=202609262300';
import * as goals from './goals.js?v=202609262300';
import * as habits from './habits.js?v=202609262300';
import * as widgets from './widgets.js?v=202609262300';
import * as sections from './sections.js?v=202609262300';
import * as gsi from './gsi.js?v=202609262300';
import * as personal from './personal.js?v=202609262300';
import * as share from './share.js?v=202609262300';
import * as theme from './theme.js?v=202609262300';
import { initCursorGlow } from './cursor-glow.js?v=202609262300';
import { releaseDragGhost } from './drag-cleanup.js?v=202609262300';
import * as composer from './composer.js?v=202609262300';
import { initDropToAttach, handleIncomingShare } from './attach.js?v=202609262300';
import * as finance from './finance.js?v=202609262300';
import * as health from './health.js?v=202609262300';
import * as medStats from './med-stats.js?v=202609262300';
import * as eisenhower from './eisenhower.js?v=202609262300';
import * as healthPulse from './health-pulse.js?v=202609262300';
import * as travel from './travel.js?v=202609262300';
import * as reference from './reference.js?v=202609262300';
import * as notebook from './notebook.js?v=202609262300';
import * as trash from './trash.js?v=202609262300';
import * as backup from './backup.js?v=202609262300';
import * as entertainment from './entertainment.js?v=202609262300';
import * as taskModal from './task-modal.js?v=202609262300';
import { decorateLinkRows } from './link-preview.js?v=202609262300';
import { flushLocalSave } from './state.js?v=202609262300';
import * as healthCheck from './health-check.js?v=202609262300';
import * as dateShortcuts from './date-shortcuts.js?v=202609262300';
import * as expandView from './expand-view.js?v=202609262300';
import * as mapCoords from './map-click-coords.js?v=202609262300';
import * as calScribble from './calendar-scribble.js?v=202609262300';
import * as whiteboard from './whiteboard.js?v=202609262300';
import * as search from './search.js?v=202609262300';
import * as cloud from './supabase.js?v=202609262300';
import { applyNavOrder, initNavSorting } from './nav-order.js?v=202609262300';
import * as gcal from './google-calendar.js?v=202609262300';
import { initCommunicationBridge } from './communication-bridge.js?v=202609262300';
import { initNgdrTrackerBridge } from './ngdr-tracker-bridge.js?v=202609262300';
...
Object.assign(window,
  ...
  { addLink: widgets.addLink, delLink: widgets.delLink, editLink: widgets.editLink,
    ...
    addFeed: widgets.addFeed, delFeed: widgets.delFeed, editFeed: widgets.editFeed,
    toggleFeedEdit: widgets.toggleFeedEdit,
  ...
  { saveHealthNotes: health.saveHealthNotes, addHealthLink: health.addHealthLink, delHealthLink: health.delHealthLink,
    ...
    toggleEisMove: eisenhower.toggleEisMove,
    onEisCardClick: eisenhower.onEisCardClick,
    openEisComposer: eisenhower.openEisComposer, closeEisComposer: eisenhower.closeEisComposer,
    submitEisComposer: eisenhower.submitEisComposer, onEisComposerInput: eisenhower.onEisComposerInput,
    onEisComposerProject: eisenhower.onEisComposerProject, onEisComposerKey: eisenhower.onEisComposerKey,
  ...
  { setHPRange: healthPulse.setHPRange, shiftHPPeriod: healthPulse.shiftHPPeriod,
    ...
    setHPTimelineCombo: healthPulse.setHPTimelineCombo,
    shiftHPTimelineWeek: healthPulse.shiftHPTimelineWeek,
    toggleHPHiddenLog: healthPulse.toggleHPHiddenLog, toggleHPLogCollapsed: healthPulse.toggleHPLogCollapsed },
  ...
  { addNotebookSection: notebook.addNotebookSection, switchNotebookSection: notebook.switchNotebookSection,
    ...
    addGoogleLinkGroup: notebook.addGoogleLinkGroup, switchGoogleLinkGroup: notebook.switchGoogleLinkGroup,
    renameGoogleLinkGroup: notebook.renameGoogleLinkGroup, archiveGoogleLinkGroup: notebook.archiveGoogleLinkGroup,
    restoreGoogleLinkGroup: notebook.restoreGoogleLinkGroup, delGoogleLinkGroup: notebook.delGoogleLinkGroup,
    addGoogleLink: notebook.addGoogleLink, editGoogleLink: notebook.editGoogleLink,
    archiveGoogleLink: notebook.archiveGoogleLink, restoreGoogleLink: notebook.restoreGoogleLink,
    delGoogleLink: notebook.delGoogleLink, toggleGoogleLinkEdit: notebook.toggleGoogleLinkEdit,
    toggleGoogleLinkArchive: notebook.toggleGoogleLinkArchive },
  ...
  { addEntertainment: entertainment.addEntertainment, delEntertainment: entertainment.delEntertainment,
    ...
    openTaskModalDatePicker: taskModal.openTaskModalDatePicker,
    ...
    taskModalLabelFilter: taskModal.taskModalLabelFilter, taskModalToggleLabel: taskModal.taskModalToggleLabel,
    sweepDuplicateTasks: cloud.sweepDuplicateTasks,
    ...
    taskModalToggleMenu: taskModal.taskModalToggleMenu, taskModalCopyLink: taskModal.taskModalCopyLink,
    taskModalDuplicate: taskModal.taskModalDuplicate,
    taskModalSubEditStart: taskModal.taskModalSubEditStart, taskModalSubEditSave: taskModal.taskModalSubEditSave,
    taskModalSubEditCancel: taskModal.taskModalSubEditCancel,
...
/* Before the first render, so the sidebar never paints in file order and
   then visibly jump into the user's order a frame later. */
applyNavOrder();
initNavSorting();
...
try {
  ...
  if (/[?&]debug=shake\b/.test(location.search)) {
    import("./shake-probe.js?v=202609262300")
