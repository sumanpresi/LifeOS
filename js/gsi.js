...
import { state, uid, esc, persist, rerender, todayKey, touch, commitWithoutRender } from './state.js?v=202609262330';
import { openDateSheet } from './date-sheet.js?v=202609262330';
import { isComposerOpen, composerHtml, openComposer } from './composer.js?v=202609262330';
...
import { markDragJustEnded, boardColHeadHtml, isColCollapsed, capBoardColumnHeights, initBoardWheelScroll,
         applyHorizon, horizonWrapHtml } from './tasks.js?v=202609262330';
import { toast, autoGrow, preserveBoardScroll } from './ui.js?v=202609262330';
/* Priority now colours the checkbox ring instead of a flag button — the
   helper lives in tasks.js so all three boards agree. */
import { prioClass } from './tasks.js?v=202609262330';
import { releaseDragGhost } from './drag-cleanup.js?v=202609262330';
import { describeLink } from './attach.js?v=202609262330';
import { moveToTrash } from './trash.js?v=202609262330';
import { checkGrammar } from './text-tools.js?v=202609262330';
import { mountRichEditor, unmountRichEditor, getRichEditor } from './rich-text.js?v=202609262330';
import { syncTaskToGoogle } from './google-calendar.js?v=202609262330';
    ...
    <div class="gsi-card ${item.status === "done" ? "done" : ""}">
      ...
      <div class="gsi-card-main">
        ...
        ${due ? `<div class="gsi-date-row ${due.cls}"><span class="date-popover-wrap">
            <button class="gsi-date-display date-popover-trigger" onclick="toggleDatePopover(event,'gsi-date-${item.id}')">📅 ${due.text}</button>
          ...
          : `<div class="gsi-date-row"><span class="date-popover-wrap">
              <button class="gsi-add-date date-popover-trigger" onclick="toggleDatePopover(event,'gsi-date-${item.id}')">📅 Add date</button>
