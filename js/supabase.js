...
import { SUPABASE_URL, SUPABASE_ANON_KEY } from './config.js?v=202609041400';
import { state, replaceState, persist, setRemoteSaver, uid, esc, rerender, flushPendingSave } from './state.js?v=202609041400';
import { setSyncPill, nowTime, toast, isUserTyping } from './ui.js?v=202609041400';
import { pushCommunicationUpdate, mergeCommunication } from './communication-bridge.js?v=202609041400';
import { pushNgdrTrackerUpdate } from './ngdr-tracker-bridge.js?v=202609041400';
import { mergeBoardData } from './whiteboard.js?v=202609041400';
import { takeSnapshot } from './backup.js?v=202609041400';
import { moveToTrash } from './trash.js?v=202609041400';
import { mergeNoteInk, redrawAllInk } from './note-ink.js?v=202609041400';
import { hasUnsavedComposerDraft } from './composer.js?v=202609041400';
import { flushJournalEditor } from './widgets.js?v=202609041400';
import { flushNotebookEditor } from './notebook.js?v=202609041400';
