...
import { SUPABASE_URL, SUPABASE_ANON_KEY } from './config.js?v=202609262300';
import { state, replaceState, resetLocalStateForNewAccount, persist, setRemoteSaver, uid, esc, rerender, flushPendingSave } from './state.js?v=202609262300';
import { setSyncPill, nowTime, toast, isUserTyping } from './ui.js?v=202609262300';
import { pushCommunicationUpdate, mergeCommunication } from './communication-bridge.js?v=202609262300';
import { pushNgdrTrackerUpdate } from './ngdr-tracker-bridge.js?v=202609262300';
import { mergeBoardData } from './whiteboard.js?v=202609262300';
import { takeSnapshot } from './backup.js?v=202609262300';
import { moveToTrash } from './trash.js?v=202609262300';
import { mergeNoteInk, redrawAllInk } from './note-ink.js?v=202609262300';
import { hasUnsavedComposerDraft } from './composer.js?v=202609262300';
import { flushJournalEditor } from './widgets.js?v=202609262300';
import { flushNotebookEditor } from './notebook.js?v=202609262300';
