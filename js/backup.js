...
import { state, replaceState, persist, rerender, esc } from './state.js?v=202609041400';
import { toast } from './ui.js?v=202609041400';
import { findOrphanedWhiteboards, dropOrphanedWhiteboards } from './whiteboard.js?v=202609041400';
...
async function applyRestoredState(next) {
  ...
  try {
    const { pushCommunicationUpdate } = await import("./communication-bridge.js?v=202609041400");
    const { pushNgdrTrackerUpdate } = await import("./ngdr-tracker-bridge.js?v=202609041400");
