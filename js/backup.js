...
import { state, replaceState, persist, rerender, esc } from './state.js?v=202609262357';
import { toast } from './ui.js?v=202609262357';
import { findOrphanedWhiteboards, dropOrphanedWhiteboards } from './whiteboard.js?v=202609262357';
...
async function applyRestoredState(next) {
  ...
  try {
    const { pushCommunicationUpdate } = await import("./communication-bridge.js?v=202609262357");
    const { pushNgdrTrackerUpdate } = await import("./ngdr-tracker-bridge.js?v=202609262357");
